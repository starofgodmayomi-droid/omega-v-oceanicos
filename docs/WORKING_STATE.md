...
| pending   | Dashboard revocation control    | Locally verified; not yet committed or published       |
...
The last full local verification after fixing the web/API contract inventory observed 305 passing tests and a successful build. The repository may contain generated build output ignored by Git; only intended source and documentation changes should be committed.
