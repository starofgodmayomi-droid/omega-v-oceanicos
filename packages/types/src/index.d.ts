...
export type SceneState = 'darkness' | 'possibility' | 'ocean' | 'star' | 'water-form' | 'many-forms' | 'loneliness' | 'human-form' | 'misrecognition' | 'boundary' | 'question' | 'forest' | 'return';
 ...
 */
export type PersistenceCoordinationMode = 'local-single-process' | 'operator-coordinated' | 'external-coordinator' | 'invalid';
