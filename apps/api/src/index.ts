...
app.get('/subsystems', (req: Request, res: Response) => {
  const subsystems = [
    ...
    {
      id: 'observer',
      name: 'Observation Kernel',
      category: 'core',
      package: '@omega-v/observer',
      status: 'active',
      description: 'Canonical claim normalization and sensory intake',
    },
    {
      id: 'lexicon',
      name: 'Universal Lexicon',
      category: 'core',
      package: '@omega-v/lexicon',
      status: 'active',
      description: 'Legibility verdicts in Naijá and English',
    },
    {
      id: 'edge',
      name: 'Edge Observer',
      category: 'core',
      package: '@omega-v/edge',
      status: 'active',
      description: 'Edge observation buffering and Merkle batching',
    },
    {
      id: 'compiler',
      name: 'Rule & Contract Compiler',
      category: 'core',
      package: '@omega-v/compiler',
      status: 'active',
      description: 'Rule and contract compiler engine into Oceanicum IR bytecode',
    },
    {
      id: 'ir',
      name: 'Oceanicum VM',
      ...
      package: '@omega-v/ir',
      status: 'active',
      description: 'Oceanicum virtual machine bytecode instruction evaluation',
    },
    {
      id: 'kernel',
      name: 'Oceanic State Kernel',
      category: 'core',
      package: '@omega-v/kernel',
      status: 'active',
      description: 'Core state machine Sn lifecycle and lineage transition',
    },
    ...
    },
    {
      ...
      category: 'runtime',
      package: '@omega-v/coordination',
      status: 'active',
      description: 'Bounded asynchronous worker leases and builder dispatch',
    },
    {
      id: 'runtime',
      name: 'Agent Execution Runtime',
      category: 'runtime',
      package: '@omega-v/runtime',
      status: 'active',
      description: 'Modular sequential agent execution loop with bounded memory fabric',
    },
    {
      id: 'vaas',
      name: 'VaaS Gateway',
    ...
    },
    {
      ...
      status: 'active',
      description: 'Tiered rate limiting, replay defense, and client quotas',
    },
    {
      id: 'learning',
      name: 'Predictive Learning Engine',
      category: 'runtime',
      package: '@omega-v/learning',
      status: 'active',
      description: 'Empirical prediction validation and continuous system learning',
    },
    {
      id: 'evm',
      name: 'Oceanic Virtual Machine',
      category: 'runtime',
      package: '@omega-v/evm',
      status: 'active',
      description: 'Oceanic Verifiable Virtual Machine stack bytecode execution',
    },
    {
      id: 'orchestrator',
      name: 'Swarm Orchestrator',
      category: 'runtime',
      package: '@omega-v/orchestrator',
      status: 'active',
      description: 'Parallel multi-task worker dispatch and swarm orchestrator',
    },
    {
      id: 'worker',
      name: 'Verifiable Worker Pool',
      category: 'runtime',
      package: '@omega-v/worker',
      status: 'active',
      description: 'Verifiable worker pool, reproducible builds & SLSA-L3 attestations',
    },
    {
      id: 'scheduler',
      name: 'Autonomous Scheduler',
      category: 'runtime',
      package: '@omega-v/scheduler',
      status: 'active',
      description: 'Autonomous periodic verification task scheduler',
    },
    {
      id: 'intent',
      name: 'Intent Solver Engine',
      category: 'runtime',
      package: '@omega-v/intent',
      status: 'active',
      description: 'AI agent intent solver and composable trade settlement',
    },
    {
      id: 'pipeline',
      name: 'CI/CD Pipeline Orchestrator',
      category: 'runtime',
      package: '@omega-v/pipeline',
      status: 'active',
      description: 'Automated verified CI/CD pipeline orchestrator & gate evaluator',
    },
    {
      id: 'enclave',
      name: 'Hardware TEE Enclave',
      category: 'runtime',
      package: '@omega-v/enclave',
      status: 'active',
      description: 'Hardware TEE confidential computing & remote attestation engine',
    },
    {
      id: 'mood',
      name: 'System Mood Evaluator',
      category: 'runtime',
      package: '@omega-v/mood',
      status: 'active',
      description: 'Collective emotional tone and system mood evaluator',
    },
    {
      id: 'webhook',
      name: 'Event Webhook Dispatcher',
      category: 'runtime',
      package: '@omega-v/webhook',
      status: 'active',
      description: 'Real-time verification event dispatch and push delivery',
    },
    ...
    // ─── CONSENSUS (12) ───
    {
      ...
      status: 'active',
      description: 'Multi-provider consensus aggregation and signed receipts',
    },
    {
      id: 'federation',
    ...
    {
      id: 'consensus',
      name: 'BFT Consensus Engine',
      category: 'consensus',
      package: '@omega-v/consensus',
      status: 'active',
      description: 'Plural BFT consensus engine with 2/3+1 quorum certificates',
    },
    {
      id: 'mesh',
      name: 'P2P Gossip Mesh',
      category: 'consensus',
      package: '@omega-v/mesh',
      status: 'active',
      description: 'Peer-to-peer epidemic gossip and verifiable message propagation',
    },
    {
      id: 'sequencer',
      name: 'Fair Sequencer Engine',
      category: 'consensus',
      package: '@omega-v/sequencer',
      status: 'active',
      description: 'MEV-resistant fair sequencer and verifiable delay functions',
    },
    {
      id: 'bridge',
      name: 'Cross-Chain Bridge',
      category: 'consensus',
      package: '@omega-v/bridge',
      status: 'active',
      description: 'Cross-chain cryptographic bridge and light client proofs',
    },
    {
      id: 'relay',
      name: 'Cross-Domain Relayer',
      category: 'consensus',
      package: '@omega-v/relay',
      status: 'active',
      description: 'Decentralized cross-shard & cross-rollup packet relaying',
    },
    {
      id: 'mempool',
      name: 'Transaction Mempool',
      category: 'consensus',
      package: '@omega-v/mempool',
      status: 'active',
      description: 'High-throughput transaction mempool and MEV bundle harvesting',
    },
    {
      id: 'staking',
      name: 'Proof-of-Stake Delegation',
      category: 'consensus',
      package: '@omega-v/staking',
      status: 'active',
      description: 'Proof-of-stake delegation and validator slashing engine',
    },
    {
      id: 'amm',
      name: 'Verifiable AMM Engine',
      category: 'consensus',
      package: '@omega-v/amm',
      status: 'active',
      description: 'Constant product automated market maker & verifiable liquidity pools',
    },
    {
      id: 'attestor',
      name: 'Threshold Attestor Network',
      category: 'consensus',
      package: '@omega-v/attestor',
      status: 'active',
      description: 'Decentralized threshold multi-signature attestation network',
    },
    {
      id: 'rollup',
      name: 'L2 Rollup Engine',
      category: 'consensus',
      package: '@omega-v/rollup',
      status: 'active',
      description: 'Layer-2 rollup execution engine and state transition proofs',
    },
    ...
    // ─── VERIFICATION (12) ───
    {
      ...
      package: '@omega-v/verification',
      status: 'active',
      description: 'Multi-model rule evaluation and evidence path compilation',
    },
    {
      id: 'attestation',
      name: 'Attestation Service',
      category: 'verification',
      package: '@omega-v/attestation',
      status: 'active',
      description: 'Cryptographic HMAC-SHA256 and Ed25519 proof generation',
    },
    {
      id: 'analytics',
    ...
    {
      id: 'green',
      name: 'Green Evaluation Engine',
      category: 'verification',
      package: '@omega-v/green',
      status: 'active',
      description: 'Grounded invariant verification & true GREEN state evaluation',
    },
    {
      id: 'evidence',
      name: 'Evidence Graph Engine',
      category: 'verification',
      package: '@omega-v/evidence',
      status: 'active',
      description: 'Evidence graph engine & multi-path traversal',
    },
    ...
    // ─── GOVERNANCE (11) ───
    {
      ...
      category: 'governance',
      package: '@omega-v/evolution',
      status: 'active',
      description: 'Drift analysis and controlled rule recompilation lifecycle',
    },
    {
      id: 'dispute',
    ...
    {
      id: 'dissensus',
      name: 'Dissensus Reconciler',
      category: 'governance',
      package: '@omega-v/dissensus',
      status: 'active',
      description: 'Multi-model dissent preservation and dispute mediation',
    },
    {
      id: 'auth',
    ...
    {
      id: 'reputation',
      name: 'Agent Reputation Engine',
      category: 'governance',
      package: '@omega-v/reputation',
      status: 'active',
      description: 'Agent reputation scoring, weighted feedback & decay',
    },
    {
      id: 'governor',
      name: 'Protocol Governor Engine',
      category: 'governance',
      package: '@omega-v/governor',
      status: 'active',
      description: 'Timelocked on-chain decentralized autonomous governance',
    },
    {
      id: 'governance',
      name: 'Autonomous Governance',
      category: 'governance',
      package: '@omega-v/governance',
      status: 'active',
      description: 'Protocol governance parameter adaptation engine',
    },
    {
      id: 'human',
      name: 'Human Authorization Gate',
      category: 'governance',
      package: '@omega-v/human',
      status: 'active',
      description: 'Attributed human authorization gate and value judgments',
    },
    {
      id: 'security',
      name: 'Security Engine',
      category: 'governance',
      package: '@omega-v/security',
      status: 'active',
      description: 'Autonomous capability tokens and least-privilege security engine',
    },
    {
      id: 'friction',
      name: 'Friction & Dissent Ledger',
      category: 'governance',
      package: '@omega-v/friction',
      status: 'active',
      description: 'Friction quantification, system drag & dissent ledger',
    },
    {
      id: 'registry',
      name: 'Verifiable Artifact Registry',
      category: 'governance',
      package: '@omega-v/registry',
      status: 'active',
      description: 'Decentralized verifiable package registry & advisory security',
    },
    ...
    },
    {
      ...
      name: 'Memory Fabric',
      category: 'storage',
      package: '@omega-v/remember',
      status: 'active',
      description: 'Append-only hash-chained state memory with AES-256-GCM encryption',
    },
    {
      id: 'store',
      name: 'Provenance Store',
      category: 'storage',
      package: '@omega-v/store',
      status: 'active',
      description: 'Durable Provenance Store for append-only execution records',
    },
    {
      id: 'graph',
      name: 'Provenance Knowledge Graph',
      category: 'storage',
      package: '@omega-v/graph',
      status: 'active',
      description: 'Provenance Knowledge Graph Engine & DAG lineage traversal',
    },
    {
      id: 'da',
      name: 'Data Availability Engine',
      category: 'storage',
      package: '@omega-v/da',
      status: 'active',
      description: 'Data availability sampling and KZG commitments',
    },
    {
      id: 'sharding',
      name: 'Adaptive Sharding Engine',
      category: 'storage',
      package: '@omega-v/sharding',
      status: 'active',
      description: 'Adaptive state sharding and atomic 2PC cross-shard transactions',
    },
    {
      id: 'dht',
      name: 'DHT Overlay Network',
      category: 'storage',
      package: '@omega-v/dht',
      status: 'active',
      description: 'Kademlia distributed hash table storage overlay',
    },
  ];
